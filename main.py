...
def main():
    ...
    app.tambah_event("Festival Buku Gramedia", "2023-12-05", 250000, "Konser di Stadion Mandala Krida", 10)
    app.tambah_event("Theater Universitas Jenderal Achmad Yani", "2023-12-10", 300000, "Kampus 1", 12)
